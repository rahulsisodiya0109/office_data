...
public class Reporting extends TestListenerAdapter {
	...
	public void onTestSuccess(ITestResult testResult) {
		...
		logger.log(Status.PASS,MarkupHelper.createLabel(testResult.getName(), ExtentColor.GREEN));  // send the pass information
	...
	public void onTestFailure(ITestResult testResult) {
		...
		logger=extent.createTest(testResult.getName());		// create a new entry in the report
		logger.log(Status.FAIL,MarkupHelper.createLabel(testResult.getName(), ExtentColor.RED));  // send the fail information
	...
	public void onTestSkip(ITestResult testResult) {
		...
		logger=extent.createTest(testResult.getName());		// create a new entry in the report
		logger.log(Status.SKIP,MarkupHelper.createLabel(testResult.getName(), ExtentColor.ORANGE));  // send the skip information
	}
