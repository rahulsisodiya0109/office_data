...
public class TestLinkAPIClient implements TestLinkAPIConst {
	 ...
	 * Cache Variables
	 * 
	 * The way the client has been written it accesses the API many times for the
	 * same information so the following is a way to cache the information if the
	 * user of the api chooses to cache.
	 */
	...
	/**
	 * The value in the TestLink database user record for API access. For TestLink
	 * version 1.8.2 this value had to be set manually using a database update
	 * statement. See the TestLink API documentation for more information.
	 * <p>
	 * Example:
	 * <p>
	...
	/**
	 * The TestLink API URL. See the TestLink API documentation for more
	 * information.
	 * <p>
	...
	/**
	 * Construct an instance and indicate if cache capabilities should be enabled or
	 * disabled.
	 * <p>
	 * If the cache is enabled during instantiation then the instance will ignore
	 * all external changes made either manually or by other instances of this class
	 * to the TestLink database. Therefore, results will only be up to date with the
	 * first query performed by the instance unless changes are made by the
	 * instance. If a change is made to the TestLink database by the instance then
	 * the cache is reset.
	 * 
	...
	/**
	 * Report a test execution result for a test case by test project name and test
	 * plan name for a specific build.
	 * <p>
	 * If the build is left as null then the system is allowed to guess on the
	 * latest build for the test case.
	 * 
	 * @param projectName             Required
	 * @param testPlanName            Required
	 * @param testCaseNameOrVisibleID Required (Test Case Name or ID on web-page
	 *                                tree)
	 ...
	 * @throws TestLinkAPIException
	 */
	public TestLinkAPIResults reportTestCaseResult(String projectName, String testPlanName,
			String testCaseNameOrVisibleID, String buildName, String execNotes, String testResultStatus)
			throws TestLinkAPIException {
		Integer projectID = TestLinkAPIHelper.getProjectID(this, projectName);
		if (projectID == null) {
			throw new TestLinkAPIException("The project " + projectName + " was not found and the test case "
		...
		if (planID == null) {
			throw new TestLinkAPIException("The plan " + testPlanName + " was not found and the test case "
					+ testCaseNameOrVisibleID + " could not be accessed to report a test result.");
		}
		Integer caseID = TestLinkAPIHelper.getTestCaseID(this, projectID, testCaseNameOrVisibleID);
		if (caseID == null) {
			throw new TestLinkAPIException(
					"The test case identifier " + caseID + " was not found and the test case " + testCaseNameOrVisibleID
							+ " could not be accessed to report a test result to test plan " + testPlanName + ".");
		}
		...
		if (buildName != null) {
			...
			if (buildID == null) {
				throw new TestLinkAPIException("The build name " + buildName + " was not found in test plan "
						+ testPlanName + " and the test result for test case " + testCaseNameOrVisibleID
	...
	/**
	 * Report a test execution result for a test case by test plan identifier and
	 * test case identifier for a specific build identifier.
	 * 
	 * If the build identifier is not provided then the system is allowed to guess
	 * on the latest build for the test case.
	 * 
	 ...
	 * @param testResultStatus Required
	 */
	public TestLinkAPIResults reportTestCaseResult(Integer testPlanID, Integer testCaseID, Integer buildID,
			String execNotes, String testResultStatus) throws TestLinkAPIException {
		Boolean guess = new Boolean(true);
		if (buildID != null) {
			guess = new Boolean(false);
		}
		TestLinkAPIResults results = reportTestCaseResult(testPlanID, testCaseID, buildID, null, guess, execNotes,
				testResultStatus);
		return results;
	}

	/**
	 * This method supports the TestLink API set of parameters that can be used to
	 ...
	 */
	public TestLinkAPIResults reportTestCaseResult(Integer testPlanID, Integer testCaseID, Integer buildID,
			Integer bugID, Boolean guess, String execNotes, String testResultStatus) throws TestLinkAPIException {
		Hashtable params = new Hashtable();
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
	...
	public Integer createTestSuite(String projectName, String suiteName, String description)
		...
		if (projectID != null) {
			...
			throw new TestLinkAPIException("The project " + projectName + " was not found and the test suite "
	...
	/**
	 * 
	 * Create a test suite at any level using the project identifier and the parent
	 * suite identifier information.
	 * 
	 * @param projectID   Required
	 * @param suiteName   Required
	 * @param description Required
	 ...
	 * @throws TestLinkAPIException
	 */
	public Integer createTestSuite(Integer projectID, String suiteName, String description, Integer parentID,
			Integer order, Boolean check) throws TestLinkAPIException {
		initCache();
		Hashtable params = new Hashtable();
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
	 ...
	 */
	public Integer createTestCase(String authorLoginName, String projectName, String suiteName, String testCaseName,
			String summary, String steps, String expectedResults, String importance) throws TestLinkAPIException {
		Integer projectID = TestLinkAPIHelper.getProjectID(this, projectName);
	...
	/**
	 * Create a new test case using all the variables that are provided by the
	 * TestLink API. For more information on the parameters refer to the TestLink
	 * API documentation.
	 * 
	 * @param projectID              Required
	 ...
	 * @throws TestLinkAPIException
	 */
	public Integer createTestCase(String authorLoginName, Integer projectID, Integer suiteID, String caseName,
			String summary, String steps, String expectedResults, Integer order, Integer internalID,
			Boolean checkDuplicatedName, String actionOnDuplicatedName, String executionType, String importance)
			throws TestLinkAPIException {
		initCache();
		Hashtable params = new Hashtable();
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
	...
	/*
	 * This method is not supported by the TestLink API. It is needed so that JUnit
	 * test could be run without human intervention but right now manual creation is
	 * the only way to get to all the other test.
	 * 
	 * 
	 * @param projectName
	 * 
	 ...
	 * @throws TestLinkAPIException
	 *
	 * public Integer createTestPlan( String projectName, String planName, String
	 * description) throws TestLinkAPIException { Integer projectID =
	 * TestLinkAPIHelper.getProjectID(this, projectName); if ( projectID != null ) {
	 * return createTestPlan(projectID, planName, description); } else { throw new
	 * TestLinkAPIException("The project " + projectName +
	 * " was not found and the test plan " + planName + " could not be created."); }
	 * }
	 */
	 ...
	 * @throws TestLinkAPIException
	 *
	 * public Integer createTestPlan( Integer projectID, String planName, String
	 * description) throws TestLinkAPIException { initCache(); Hashtable params =
	 * new Hashtable(); setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
	 * setParam(params, REQUIRED, API_PARAM_TEST_PROJECT_ID, projectID.toString());
	 * setParam(params, REQUIRED, "testplanname", planName); // not supported by
	 * TestLink setParam(params, REQUIRED, API_PARAM_NOTES, description);
	 * TestLinkAPIResults results = executeRpcMethod(API_METHOD_CREATE_TEST_PLAN,
	 * params); return getCreatedRecordIdentifier(results, API_RESULT_IDENTIFIER); }
	 */
	 ...
	 * @throws TestLinkAPIException
	 */
	public Integer createBuild(String projectName, String planName, String buildName, String buildNotes)
			throws TestLinkAPIException {
		Integer projectID = TestLinkAPIHelper.getProjectID(this, projectName);
		if (projectID == null) {
			throw new TestLinkAPIException("The project " + projectName + " was not found and the build " + buildName
		...
		if (planID != null) {
			...
			throw new TestLinkAPIException(
					"The plan " + planName + " was not found and the build " + buildName + " could not be created.");
		}
	}
	...
	/**
	 * Appends that latest version of a test case to a test plan with a default
	 * level of urgency. Can only handle test cases associated with first level
	 * suites.
	 * 
	 * 
	 * @param projectName  Required
	 ...
	 * @throws TestLinkAPIException
	 */
	public TestLinkAPIResults addTestCaseToTestPlan(String projectName, String planName, String testCaseName)
			throws TestLinkAPIException {
		int maxNode = 0;
		...
		maxNode++;
		TestLinkAPIResults results = addTestCaseToTestPlan(projectName, planName, testCaseName, new Integer(maxNode),
				null);
		return results;
	}

	/**
	 * Appends that latest version of a test case to a test plan with a medium
	 * urgency. Can only handle test in first level suites.
	 * 
	 * @param projectName  Required
	 * @param planName     Required
	 * @param testCaseName Required
	 ...
	 */
	public TestLinkAPIResults addTestCaseToTestPlan(String projectName, String planName, String testCaseName,
			Integer execOrder, String urgency) throws TestLinkAPIException {
		Integer projectID = TestLinkAPIHelper.getProjectID(this, projectName);
		if (projectID == null) {
			throw new TestLinkAPIException("The project " + projectName + " was not found and the test case "
		...
		Integer planID = TestLinkAPIHelper.getPlanID(this, projectID, planName);
		if (planID == null) {
			throw new TestLinkAPIException("The plan " + planName + " was not found and the test case " + testCaseName
					+ " could not be appended.");
		}
		Integer caseID = TestLinkAPIHelper.getCaseIDByName(this, projectID, testCaseName);
		if (caseID == null) {
			throw new TestLinkAPIException("The test case " + testCaseName + " was not found and the test case"
		...
		if (projectInfo == null) {
			throw new TestLinkAPIException(
					"The project information for " + projectName + " was not found and the test case " + testCaseName
							+ " could not be appended to test plan " + planName + ".");
		}
		...
		TestLinkAPIResults results = addTestCaseToTestPlan(projectID, planID, caseID, visibleTestCaseID,
				new Integer(version.toString()), execOrder, urgency);
		return results;
	}
	 ...
	 * @throws TestLinkAPIException
	 */
	public TestLinkAPIResults addTestCaseToTestPlan(Integer projectID, Integer planID, Integer testCaseID,
			String testCaseVisibleID, Integer version, Integer execOrder, String urgency) throws TestLinkAPIException {
		initCache();
		Hashtable params = new Hashtable();
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
		setParam(params, REQUIRED, API_PARAM_TEST_PROJECT_ID, projectID);
	...
	/**
	 * Get a list of all the existing test projects for the instantiated TestLink
	 * URL.
	 * 
	 * @return The results from the TestLink API as a list of Map entries
	 */
	...
	public TestLinkAPIResults getProjectTestPlans(Integer projectID) throws TestLinkAPIException {
		...
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
		setParam(params, REQUIRED, API_PARAM_TEST_PROJECT_ID, projectID);
		return execXmlRpcMethodWithCache(API_METHOD_GET_PROJECT_TEST_PLANS, params, projectID);
	}
	 ...
	 * @throws TestLinkAPIException
	 */
	public TestLinkAPIResults getLatestBuildForTestPlan(String projectName, String planName)
			throws TestLinkAPIException {
		Integer projectID = TestLinkAPIHelper.getProjectID(this, projectName);
		if (projectID == null) {
			throw new TestLinkAPIException("The project " + projectName + " was not found.");
	...
	public TestLinkAPIResults getLatestBuildForTestPlan(Integer planID) throws TestLinkAPIException {
		...
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
		setParam(params, REQUIRED, API_PARAM_TEST_PLAN_ID, planID);
		return execXmlRpcMethodWithCache(API_METHOD_GET_LATEST_BUILD_FOR_PLAN, params, planID);
	}
	...
	public TestLinkAPIResults getFirstLevelTestSuitesForTestProject(Integer projectID) throws TestLinkAPIException {
		...
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
		setParam(params, REQUIRED, API_PARAM_TEST_PROJECT_ID, projectID);
		return execXmlRpcMethodWithCache(API_METHOD_GET_FIRST_LEVEL_SUITES_FOR_PROJECT, params, projectID);
	}
	...
	/**
	 * Get test case by name. As an option the results can be restricted to a
	 * project and and test suite name.
	 * 
	 * @param testCaseName    Required
	 ...
	 * @throws TestLinkAPIException
	 */
	public TestLinkAPIResults getTestCaseIDByName(String testCaseName, String testProjectName, String testSuiteName)
			throws TestLinkAPIException {
		Hashtable params = new Hashtable();
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
	 ...
	 * @return The results from the TestLink API as a list of Map entries
	 */
	public TestLinkAPIResults getCasesForTestSuite(Integer testProjectID, Integer testSuiteID)
			throws TestLinkAPIException {
	 ...
	 * @throws TestLinkAPIException
	 */
	public TestLinkAPIResults getTestSuitesForTestPlan(String projectName, String planName)
			throws TestLinkAPIException {
		Integer projectID = TestLinkAPIHelper.getProjectID(this, projectName);
		if (projectID == null) {
	...
	public TestLinkAPIResults getTestSuitesForTestPlan(Integer testPlanID) throws TestLinkAPIException {
		...
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
		setParam(params, REQUIRED, API_PARAM_TEST_PLAN_ID, testPlanID);
		return execXmlRpcMethodWithCache(API_METHOD_GET_SUITES_FOR_PLAN, params, testPlanID);
	}
	 ...
	 * @throws TestLinkAPIException
	 */
	public TestLinkAPIResults getLastExecutionResult(String projectName, String testPlanName,
		...
		if (caseID == null) {
			throw new TestLinkAPIException(
					"The test case " + testCaseNameOrVisibleID + " was not found and the test case"
	...
	/**
	 * Get the last execution result by plan identifier and test case internal
	 * identifier.
	 * 
	 * @param testPlanID Required
	 * @param testCaseID Required
	 ...
	 * @throws TestLinkAPIException
	 */
	public TestLinkAPIResults getLastExecutionResult(Integer testPlanID, Integer testCaseID)
			throws TestLinkAPIException {
		Hashtable params = new Hashtable();
		setParam(params, REQUIRED, API_PARAM_DEV_KEY, DEV_KEY);
		setParam(params, REQUIRED, API_PARAM_TEST_PLAN_ID, testPlanID);
		setParam(params, REQUIRED, API_PARAM_TEST_CASE_ID, testCaseID);
		return execXmlRpcMethodWithCache(API_METHOD_LAST_EXECUTION_RESULT, params, testPlanID);
	}
	 ...
	 * @throws TestLinkAPIException
	 */
	public TestLinkAPIResults getCasesForTestPlan(Integer testPlanID, Integer testCaseID, Integer buildID,
			Integer keywordID, String executed, String assignedTo, String execStatus, String execType)
			throws TestLinkAPIException {
	...
	/*
	 * Executes the XML-RPC method but checks for cached results first. Also, if an
	 * error exists in the results then the method throws an exception.
	 * 
	 ...
	 * @throws TestLinkAPIException
	 */
	private TestLinkAPIResults execXmlRpcMethodWithCache(String method, Hashtable params, Object cacheKey)
			throws TestLinkAPIException {
	 ...
	 */
	private void setParam(Hashtable params, boolean isRequired, String paramName, Object value)
			throws TestLinkAPIException {
	...
	/*
	 * There seems to be no standard message coming from the TestLink API to
	 * indicate there is an error. So this is a kludge trying to figure out if the
	 * message is an error since it contains both a message and code.
	 * 
